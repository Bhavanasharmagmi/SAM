...
BASE_URL = 'https://picassetimporter-qa.k8s.genmills.com'
...
async def process_all_items(items_to_process):
    ...
    async with async_playwright() as p:
        ...
        try:
            browser_context = await p.chromium.launch_persistent_context(user_data_dir=EDGE_USER_DATA_DIR, executable_path=EDGE_EXECUTABLE_PATH, headless=False, accept_downloads=True, slow_mo=50, timeout=60000)
